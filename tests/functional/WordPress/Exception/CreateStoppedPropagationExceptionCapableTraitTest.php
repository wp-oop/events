...
use WpOop\Events\Exception\CreateStoppedPropagationExceptionCapableTrait as TestSubject;
...
class CreateStoppedPropagationExceptionCapableTraitTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'WpOop\Events\Exception\CreateStoppedPropagationExceptionCapableTrait';
