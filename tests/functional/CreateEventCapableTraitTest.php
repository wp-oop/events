...
namespace WpOop\Events\Tests\Func;

use WpOop\Events\CreateEventCapableTrait as TestSubject;
use stdClass;
...
class CreateEventCapableTraitTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'WpOop\Events\CreateEventCapableTrait';
