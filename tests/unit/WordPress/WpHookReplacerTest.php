...
namespace WpOop\Events\FuncTest;

use WpOop\Events\Exception\StoppedPropagationExceptionInterface;
use WpOop\Events\WpHookReplacer as TestSubject;
use Mockery;
...
class WpHookReplacerTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'WpOop\Events\WpHookReplacer';
