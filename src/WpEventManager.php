...
use WpOop\Events\CreateEventCapableTrait;
use WpOop\Events\EventCacheTrait;
use WpOop\Events\HashCallableCapableTrait;
use WpOop\Events\NormalizeEventCapableTrait;
use WpOop\Events\Exception\CreateStoppedPropagationExceptionCapableTrait;
